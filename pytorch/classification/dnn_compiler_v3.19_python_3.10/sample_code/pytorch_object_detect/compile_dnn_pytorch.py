...
if __name__ == "__main__":
    ...
    # model_path = r"./saved_models/customer_test/Epoch-99-Quantized_True_1110.pth"
    # model_path = r"./saved_models/test/Epoch-99-Quantized_True_circle_test.pth"
    model_path = r"./saved_models/Epoch-499-Quantized_True_circle.pth"
    # label_file = r'./model/config/label_map/circle-rectangle-model-labels.txt'
    label_file = r"./model/config/label_map/pcscreen-phonescreen_labels.txt"
    ...
    # overrides.append("DNN_NAME=dnn_fd_pic_sim_1016")
    # overrides.append("DNN_NAME=dnn_fd_pic_sim_1110")
    overrides.append("DNN_NAME=dnn_circle_test_sim_1111_499")
    overrides.append("FORCE_PATCHES=[170940_177827]")
