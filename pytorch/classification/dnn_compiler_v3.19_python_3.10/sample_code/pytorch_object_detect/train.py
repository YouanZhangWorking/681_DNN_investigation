...
if __name__ == '__main__':
    ...
    train_cfg_path = r"C:/Users/7000031151/OneDrive - Sony/04_IMX681/Compiler/dnn_compiler_v3.19/dnn_compiler_v3.19/dnn_compiler_v3.19_python_3.10/sample_code/pytorch_object_detect/config/train_config.yaml"
    ...
    # checkpoint_folder = r"C:\\Users\\7000031151\\OneDrive - Sony\\04_IMX681\\Compiler\\dnn_compiler_v3.19\\dnn_compiler_v3.19\\dnn_compiler_v3.19_python_3.10\\sample_code\\pytorch_object_detect\\saved_models\\test"
    ...
    priors = config.priors  # [center_y, center_x, h, w]
    ...
    for epoch in range(last_epoch + 1, num_epochs):
        ...
        if epoch == quantize_after:
            ...
            if hasattr(model, "module"):
                ...
                model = prepare_qat(model, config.fuse_layer_list)
