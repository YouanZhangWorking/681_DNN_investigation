...
if __name__ == "__main__":
    ...
    # model_file = "./saved_models/customer_test/Epoch-99-Quantized_True.pth"
    # model_file = "./saved_models/customer_test/Epoch-499-Quantized_True.pth"
    # model_file = "./saved_models/Epoch-299-Quantized_True.pth"
    # model_file = "./saved_models/Epoch-99-Quantized_True_1110.pth"
    # model_file = "./saved_models/test/Epoch-99-Quantized_True_circle_test.pth"
    model_file = "./saved_models/Epoch-499-Quantized_True_circle.pth"
    # model_file = "./saved_models/results/Epoch-149-Quantized_True.pth"
    label_file = './model/config/label_map/circle-rectangle-model-labels.txt'
    image_dir = './dummy_dataset/validation/images'
    # image_dir = './customer_dataset/validation/images'
    quantize = True
