...
def main():
    ...
    # Datasets
    train_data = datasets.CIFAR10("../cifar10/train/", train=True, transform=train_transform, download=False)
    val_data = datasets.CIFAR10("../cifar10/test/", train=False, transform=val_transform, download=False)
