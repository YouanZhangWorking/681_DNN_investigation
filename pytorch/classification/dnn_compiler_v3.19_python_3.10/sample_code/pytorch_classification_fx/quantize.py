...
def main():
    ...
    # 构造一个和推理时一致的 dummy 输入
    example_inputs = torch.randn(args.batch_size, 1, args.height, args.width)
    prepared_model = prepare_fx(model, qconfig_dict, example_inputs)  # fuse modules and insert observers
