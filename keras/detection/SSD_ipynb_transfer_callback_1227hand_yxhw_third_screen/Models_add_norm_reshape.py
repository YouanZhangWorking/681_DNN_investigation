...
from keras.layers import (Activation, Concatenate, Conv2D, Flatten, Input, Reshape, DepthwiseConv2D, Softmax)
...
def SSD300(input_shape, num_classes=2):
    ...
    net['split_layer1_conf_Reshape'] = tf.reshape(net['split_layer1_conf_Conv'], (-1, 600, num_classes))
    ...
    net['split_layer1_loc_Reshape'] = tf.reshape(net['split_layer1_loc_Conv'], (-1, 600, 4))
    ...
    net['split_layer2_conf_Reshape'] = tf.reshape(net['split_layer2_conf_Conv'], (-1, 480, num_classes))
    ...
    net['split_layer2_loc_Reshape'] = tf.reshape(net['split_layer2_loc_Conv'], (-1, 480, 4))
    ...
    net['split_layer3_conf_Reshape'] = tf.reshape(net['split_layer3_conf_Conv'], (-1, 120, num_classes))
    ...
    net['split_layer3_loc_Reshape'] = tf.reshape(net['split_layer3_loc_Conv'], (-1, 120, 4))
    ...
    net['split_layer4_conf_Reshape'] = tf.reshape(net['split_layer4_conf_Conv'], (-1, 36, num_classes))
    ...
    net['split_layer4_loc_Reshape'] = tf.reshape(net['split_layer4_loc_Conv'], (-1, 36, 4))
    ...
    net['split_layer5_conf_Reshape'] = tf.reshape(net['split_layer5_conf_Conv'], (-1, 6, num_classes))
    ...
    net['split_layer5_loc_Reshape'] = tf.reshape(net['split_layer5_loc_Conv'], (-1, 6, 4))
