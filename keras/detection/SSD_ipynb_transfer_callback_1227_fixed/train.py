...
if __name__ == "__main__":
    ...
    batch_size = 32
    imgcolor = 'grey'  
    save_dir = "/output/1227"
    
    # 设置SSD参数
    cls_name_path = r"voc_classes.txt"  # 导入目标检测类别；
    input_shape = [120, 160]  # 输入的尺寸大小
    anchor_size = [32, 59, 86, 113, 141, 168]   
    train_annotation_path = r'2007_train.txt'  # 训练图片路径和标签
    val_annotation_path = r'2007_val.txt'  # 验证图片路径和标签
