...
def SSD300(input_shape, num_classes=2):
    ...
    net['split_layer5_conf_Dep'] = KL.ReLU()(net['split_layer5_conf_Dep'])
    ...
    net['split_layer5_loc_Dep'] = KL.ReLU()(net['split_layer5_loc_Dep'])
    ...
    net['split_layer5_loc_Reshape'] = Reshape((6, 4))(net['split_layer5_loc_Conv'])  
